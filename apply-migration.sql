-- Script para aplicar as mudanças de controle de acesso
-- Execute este script diretamente no seu banco de dados Supabase
...
-- Definir acesso como liberado para usuários existentes (opcional - remova se quiser que todos precisem ser liberados manualmente)
UPDATE public.profiles 
SET access_granted = true 
WHERE access_granted IS NULL;

-- Definir conta como não congelada para usuários existentes
UPDATE public.profiles 
