    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[400px]">
        <DialogHeader className="text-center">
          ...
          <DialogTitle className="text-xl font-semibold text-center">Conta criada com sucesso!</DialogTitle>
          <DialogDescription className="text-center space-y-3">
            ...
            <p className="font-medium text-gray-900 bg-gray-50 px-3 py-2 rounded-md text-center">
              {email}
            </p>
