-- Dropar função existente e recriar com whatsapp
DROP FUNCTION public.get_all_profiles_simple();

-- Recriar função get_all_profiles_simple para incluir whatsapp
